    ...
    <>
      <section class="relative z-10 overflow-hidden bg-white py-20 lg:py-[120px]">
        <div class="container mx-auto">
          <h1 class=" my-5 text-4xl text-center font-bold mb-8 underline">
            Contact US
          </h1>
              ...
              <div class="mb-12 max-w-[570px] lg:mb-0">
                ...
                <div class="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div class="w-full">
                    ...
                    <a
                      href="tel: 81 414 257 9980"
                      class="text-body-color text-base"
                    >
                      <i>(+62)81 414 257 9980</i>
                    </a>
                  </div>
                </div>
                <div class="mb-8 flex w-full max-w-[370px]">
              ...
              <div class="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
                <form>
                  ...
                  <div>
                    <button
                      type="submit"
                      class="bg-[#8956F1] border-primary w-50 rounded-full border p-3 text-[#F2F2F2] transition hover:bg-opacity-90 hover:bg-[#1d0be9] shadow-2xl"
                    >
                      Send Message
                    </button>
                  </div>
